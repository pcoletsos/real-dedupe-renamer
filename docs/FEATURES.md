...
- Where: `delete_real_duplicates.spec`, `dist/delete_real_duplicates-1.4.4.exe`, `archive/`
- Status: Done
- How to verify: Run `dist/delete_real_duplicates-1.4.4.exe` or `python delete_real_duplicates.py`.
